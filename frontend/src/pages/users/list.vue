                        ...
                        <div class="col-12 col-md-auto ">
                            <div class="">
                                <div class="row  items-center q-col-gutter-sm q-px-sm">
                                    <div class="col">
                                        <div class="text-h6 text-primary">{{ $t('users') }}</div>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div>
                                <template v-if="showBreadcrumbs && $route.query.tag">
                                    <q-breadcrumbs class="q-pa-md">
                                        <q-breadcrumbs-el icon="las la-angle-left" class="text-capitalize" :label="$route.query.tag" to="/users"></q-breadcrumbs-el>
