                        ...
                        <div class="col-12 col-md-auto ">
                            <div class="">
                                <div class="row  items-center q-col-gutter-sm q-px-sm">
                                    <div class="col">
                                        <div class="text-h6 text-primary">{{ $t('vessels_details') }}</div>
                                    </div>
                                </div>
                            </div>
                        </div>
                                    ...
                                    <template v-if="!loading && item">
                                        <div class="row q-col-gutter-x-md">
                                            <div class="col">
                                                ...
                                                <q-item>
                                                    <q-item-section>
                                                        <q-item-label caption>{{ $t('code') }}: </q-item-label>
                                                    ...
                                                    <q-btn icon="las la-bars" padding="xs" round flat color="grey">
                                                        <q-menu auto-close transition-show="flip-right"  transition-hide="flip-left" self="center middle" anchor="center middle">
                                                            <q-list dense rounded nav>
                                                                <q-item link clickable v-ripple :to="`/vessels/edit/${item.id}`">
                                                                    <q-item-section>
...
<script>
	...
	export default {
		...
		methods: {
			...mapActions("vessels", [ "fetchRecord", "deleteRecord"]),
		},
		watch: {
			$route (to, from){
